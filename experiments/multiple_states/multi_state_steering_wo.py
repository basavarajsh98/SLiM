...
def prepare_dataset(max_sequence_length, path='resources/datasets/multi_state_500.pth'):
    ...
    if not os.path.exists(path):
        MAX_SAMPLES_PER_COMBINATION = 500  # Minimum samples per (topic, language, rating)
        ...
        for item in dataset['train']:
            ...
            if topic_index is not None:
                ...
                if lang in ['en', 'de'] and rating is not None:
                    ...
                    if combination_counts[combination_key] < MAX_SAMPLES_PER_COMBINATION:
